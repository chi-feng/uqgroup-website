...
<div class="people-browser clearfix">
  <div class="col-1-2">
    ...
    <a><strong>George Hansel</strong> (MIT physics)</a>
    <a><strong>Michael Lieu </strong> (MIT Aero Astro)</a>
  </div>
  <div class="col-2-2">
    <h3>Graduate Students, PhD</h3>
    <a href="profiles#conrad">Patrick Conrad</a>
    <a href="profiles#galagali">Nikhil Galagali</a>
    <a href="profiles#gorodetsky">Alex Gorodetsky</a>
    <a href="profiles#huan">Xun Huan</a>
    <a href="profiles#naveen">Naveen Kartik Conjeevaram Krishnakumar</a>
    <a href="profiles#parno">Matthew Parno</a>
    <a href="profiles#spantini">Alessio Spantini</a>
    <a href="">&nbsp;</a>
    <h3>Graduate Students, SM</h3>
    <a href="profiles#aggarwal">Raghav Aggarwal</a>
    <a href="profiles#feng">Chi Feng</a>
    <a href="profiles#mitra">Subhadeep Mitra</a>
    <a href="">&nbsp;</a>
  </div>
</div>
<br style="clear:both" />
